...
class PickRestauraunts: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        var burgerKing = Resturant(adresss: "250 W Virginia St", phoneN: "815-459-2976", restName: "Burger King", distance: 22, resturantLogo: "borgerKing", checkSwitch: false)
        var culvers = Resturant(adresss: "400 Pingree Rd", phoneN: "815-356-9090", restName: "Culvers", distance: 10, resturantLogo: "culvers", checkSwitch: false)
        var popeys = Resturant(adresss: "340 W. Virginia St.", phoneN: "779-220-4934", restName: "Popey's", distance: 10, resturantLogo: "papi2", checkSwitch: false)
        var chickFille = Resturant(adresss: "4812 Northwest Hwy", phoneN: "815-444-8611", restName: "chick-fill-a", distance: 10, resturantLogo:"chicken", checkSwitch: false)
        var subway = Resturant(adresss: "6166 Northwest Hwy", phoneN: "815-455-3535", restName: "Subway", distance: 10, resturantLogo: "subbers", checkSwitch: false)
        var jimmyjohns = Resturant(adresss: "5657 Northwest Hwy", phoneN: "815-455-2555", restName: "Jimmy Johns", distance: 10, resturantLogo: "jimmyJohns", checkSwitch: false)
        var tommys = Resturant(adresss: "363 W Virginia St", phoneN: "815-455-4966", restName: "Tommy's", distance: 10, resturantLogo: "tommys", checkSwitch: false)
